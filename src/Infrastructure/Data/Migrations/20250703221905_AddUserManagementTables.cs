        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSelectedEnvironmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastSelectedDatabase = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    CustomSettings = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSettings_Environments_LastSelectedEnvironmentId",
                        column: x => x.LastSelectedEnvironmentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSettings_LastSelectedEnvironmentId",
                table: "UserSettings",
                column: "LastSelectedEnvironmentId");
